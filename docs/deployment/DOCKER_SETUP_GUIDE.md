...
[+] Building 45.2s (12/12) FINISHED
 ...
 => exporting to image
 => => naming to docker.io/library/wontech-wontech
```
...
```
[+] Running 1/1
 ✔ Container wontech-app  Created
Attaching to wontech-app
wontech-app  |
wontech-app  | ============================================================
wontech-app  | WONTECH BUSINESS MANAGEMENT PLATFORM
wontech-app  | ============================================================
wontech-app  |
wontech-app  | 🔧 Checking database schema...
wontech-app  |
wontech-app  | 📊 Dashboard starting at: http://localhost:5001
wontech-app  | 📦 Inventory Database: Connected
wontech-app  | 📄 Invoices Database: Connected
wontech-app  |
wontech-app  | ⌨️  Press CTRL+C to stop the server
```
...
```bash
docker-compose exec wontech /bin/bash
...
- Databases should be visible in container:
  ```bash
  docker-compose exec wontech ls -lh /app/*.db
  ```
