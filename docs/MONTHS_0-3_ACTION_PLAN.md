...
**Tasks:**
- Audit WONTECH codebase (API endpoints, database schema, multi-tenant readiness)
...
### Week 7: Migrate WONTECH to Inventory Module
**Focus:** Convert existing app to multi-tenant module

**Tasks:**
- Copy WONTECH code to modules/inventory/
...
**Deliverable:** WONTECH fully migrated and multi-tenant ready
...
- Set up business email (hello@wontech.io)
