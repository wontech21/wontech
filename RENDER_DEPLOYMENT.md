...
Complete guide to deploy FIRINGup to Render.com for 24/7 cloud access.
...
6. Select "wontech21/firingup-inventory" from the list
...
### Basic Settings
- **Name:** `firingup-inventory` (or your preference)
...
3. **Monitor deployment:**
   ...
   - Look for: "🔥 FIRING UP INVENTORY DASHBOARD"
...
1. Your app URL will be: `https://firingup-inventory-xxxx.onrender.com`
   - The `xxxx` is a random string Render assigns
   - Example: `https://firingup-inventory-abc123.onrender.com`

2. Click the URL or copy it

3. Test it in your browser:
   - Should see: "🔥 Firing Up Inventory Dashboard"
...
2. Navigate to your Render URL: `https://firingup-inventory-xxxx.onrender.com`
...
curl https://firingup-inventory-xxxx.onrender.com/api/backup > backup.db
```
...
### App Issues
- GitHub Issues: https://github.com/wontech21/firingup-inventory/issues
...
- **App URL:** https://firingup-inventory-xxxx.onrender.com
- **GitHub Repo:** https://github.com/wontech21/firingup-inventory
