...
def create_pdf():
    doc = SimpleDocTemplate(
        "/Users/dell/WONTECH/docs/Auto_Reorder_System_Plan.pdf",
        pagesize=letter,
    ...
    # Title
    story.append(Paragraph("WONTECH Auto-Reorder System", title_style))
    ...
    # Build PDF
    doc.build(story)
    print("PDF created: /Users/dell/WONTECH/docs/Auto_Reorder_System_Plan.pdf")
