...
**Migration Applied:** `/Users/dell/FIRINGup/migrations/add_product_recipe_support.py`
...
2. **`/Users/dell/FIRINGup/migrations/add_product_recipe_support.py`**
   - Migration script (can be run or rolled back)

### Frontend (JavaScript):
3. **`/Users/dell/FIRINGup/static/js/dashboard.js`**
...
### Styling (CSS):
4. **`/Users/dell/FIRINGup/static/css/style.css`**
...
### Database:
5. **`/Users/dell/FIRINGup/inventory.db`**
...
/Users/dell/FIRINGup/venv/bin/python migrations/add_product_recipe_support.py --rollback
```
